...
function insert_scripts($html)
{
   ...
   $head_html .= '<script type="text/javascript" src="' . WEBSITE_URL . '/simple-cms/aloha/aloha.js"></script>';
   $head_html .= '<script type="text/javascript" src="' . WEBSITE_URL . '/simple-cms/aloha/plugins/com.gentics.aloha.plugins.Format/plugin.js"></script>';
   $head_html .= '<script type="text/javascript" src="' . WEBSITE_URL . '/simple-cms/aloha/plugins/com.gentics.aloha.plugins.Table/plugin.js"></script>';
   $head_html .= '<script type="text/javascript" src="' . WEBSITE_URL . '/simple-cms/aloha/plugins/com.gentics.aloha.plugins.List/plugin.js"></script>';
   $head_html .= '<script type="text/javascript" src="' . WEBSITE_URL . '/simple-cms/aloha/plugins/com.gentics.aloha.plugins.Link/plugin.js"></script>';
   $head_html .= '<script type="text/javascript" src="' . WEBSITE_URL . '/simple-cms/aloha/plugins/com.gentics.aloha.plugins.HighlightEditables/plugin.js"></script>';
   $head_html .= '<script type="text/javascript" src="' . WEBSITE_URL . '/simple-cms/aloha/plugins/com.gentics.aloha.plugins.TOC/plugin.js"></script>';
   $head_html .= '<script type="text/javascript" src="' . WEBSITE_URL . '/simple-cms/aloha/plugins/com.gentics.aloha.plugins.Link/delicious.js"></script>';
   $head_html .= '<script type="text/javascript" src="' . WEBSITE_URL . '/simple-cms/aloha/plugins/com.gentics.aloha.plugins.Link/LinkList.js"></script>';
   $head_html .= '<script type="text/javascript" src="' . WEBSITE_URL . '/simple-cms/aloha/plugins/com.gentics.aloha.plugins.Paste/plugin.js"></script>';
   $head_html .= '<script type="text/javascript" src="' . WEBSITE_URL . '/simple-cms/aloha/plugins/com.gentics.aloha.plugins.Paste/wordpastehandler.js"></script>';
   $head_html .= '<script type="text/javascript" src="' . WEBSITE_URL . '/simple-cms/aloha/plugins/com.example.aloha.plugins.Save/plugin.js"></script>';
   $head_html .= '<script type="text/javascript" src="' . WEBSITE_URL . '/simple-cms/aloha/plugins/com.example.aloha.plugins.Logout/plugin.js"></script>';
   $head_html .= '<script type="text/javascript" src="' . WEBSITE_URL . '/simple-cms/aloha/editor.js"></script>';
   $head_html .= '<?php } ?>';
